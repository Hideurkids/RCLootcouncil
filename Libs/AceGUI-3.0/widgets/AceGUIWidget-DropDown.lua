...
local AceGUI = LibStub("RCLootCouncil-AceGUI-3.0")
...
do
	...
	local function AddListItem(self, value, text, itemType)
		...
		if not exists then error(string.format("The given item type, %q, does not exist within AceGUI-3.0", tostring(itemType)), 2) end
