...
L["Allow notes"] = true
L["Allow multiple votes"] = true
L["Allow voting for yourself"] = true
L["Automatically loot items that can be equipped."] = true
L["Automatically open the Voting Frame when a new session starts."] = true
L["Automatically pass on items your class/spec can't use."] = true
L["Auto-loot equippable items"] = true
L["Auto-open Voting Frame"] = true
L["Auto-pass on ineligible items"] = true
L["Candidates can attach a note to their response."] = true
L["Click a guild rank to see its members, then check who should be on the council."] = true
L["Council members can vote for more than one candidate per item."] = true
L["Council members can vote for their own candidacy."] = true
L["Current council: (none)"] = true
L["Current council:"] = true
L["Log every awarded item, who got it, and when."] = true
L["Observer mode"] = true
L["Record loot history"] = true
L["See the Voting Frame without being on the council or being able to vote."] = true
...
L["Close"] = true
L["Ctrl+C to copy, then close this window."] = true
L["config"] = true
...
L["Export"] = true
L["Export the loot history as CSV text you can copy."] = true
...
L["Best in Slot"] = true
L["Big Upgrade but not BiS"] = true
L["Small Upgrade but not BiS"] = true
L["Note"] = true
L["Notes"] = true
...
L["whisperKey_bis"] = "bis, 1"
L["whisperKey_bigupgrade"] = "bigupgrade, 2"
L["whisperKey_smallupgrade"] = "smallupgrade, 3"
L["whisperKey_offspec"] = "offspec, 4"
L["whisperKey_pass"] = "pass, 5"
