								...
								args = {
									...
									versionTest = {
										...
										func = function()
											...
											LibStub("RCLootCouncil-AceConfigDialog-3.0"):CloseAll()
							...
							ignoreOptions = {
								...
								args = {
									...
									ignoreInput = {
										...
										set = function(info, val) tinsert(self.db.profile.ignore, val); LibStub("RCLootCouncil-AceConfigRegistry-3.0"):NotifyChange("RCLootCouncil") end,
									},
									ignoreList = {
										order = 3,
										name = L["Ignore List"],
										...
										values = function()
											local t = {}
											for i = 1, tgetn(self.db.profile.ignore) do
					...
					announcementsTab = {
						...
						args = {
							...
							reset = {
								...
								confirm = true,
								func = function()
									for i = 1, tgetn(self.db.profile.awardText) do
								...
								args = {
									...
									list = {
										...
										values = function()
											...
											if tgetn(t) == 0 then t[self.playerName] = self.playerName end -- Insert ourself
...
function RCLootCouncil:DBGet(info)
	return self.db.profile[info[tgetn(info)]]
end

function RCLootCouncil:DBSet(info, val)
	self.db.profile[info[tgetn(info)]] = val
	self:ConfigTableChanged(info[tgetn(info)])
end
